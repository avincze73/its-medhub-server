...
(function(b){
    ...
    b.extend(b.jgrid,{
        ...
        stripHtml:function(d){
            d+="";
            var i=/<("[^"]*"|'[^']*'|[^'">])*>/gi;
            if(d)return(d=d.replace(i,""))&&d!=="&nbsp;"&&d!=="&#160;"?d.replace(/\"/g,"'"):"";else return d
                },
        realType:function(d){
        ...
        parseDate:function(d,i){
            ...
            if(i&&i!==null&&i!==undefined){
                ...
                i=i.split(c);
                d=d.split(c);
                var l=b.jgrid.formatter.date.monthNames,a=b.jgrid.formatter.date.AmPm,q=function(x,y){
                    if(x===0){
                        if(y===12)y=0
                            }else if(y!==12)y+=12;
                    return y
...
from:function(d){
    ...
    this._getOrder=function(o,n,t,F,T){
        ...
        fa=F=="float"||F=="number"||F=="currency"||F=="numeric"?function(R){
        ...
        if(!this.grid){
            ...
            dragMove:function(e){
                if(this.resizing){
                    ...
                    var j=c.direction==="ltr"?e.width+f:e.width-f,m;
                    if(j>33){
                        this.curGbox.css({
...
populateVisible:function(){
    ...
    if(e){
        ...
        if(f[0].rows.length)try{
            ...
            var s=Math.round(f.position().top)-j,A=s+f.height();
            m*=C;
            var z,u,w;
...
selectionPreserver:function(e){
    var f=e.p,j=f.selrow,m=f.selarrrow?b.makeArray(f.selarrrow):null,p=e.grid.bDiv.scrollLeft,C=f.gridComplete;
    f.gridComplete=function(){
        f.selrow=null;
        f.selarrrow=[];
        if(f.multiselect&&m&&m.length>0)for(var s=0;s<m.length;s++)m[s]!=
...
if(this.tagName.toUpperCase()!="TABLE")alert("Element is not a table");
    ...
    if(this.p.colNames.length!==this.p.colModel.length)alert(b.jgrid.errors.model);
        ...
        var q=b("<div class='ui-jqgrid-view'></div>"),x,y=b.browser.msie?true:false,E=b.browser.webkit||b.browser.safari?true:false;
        a=this;
    ...
    var C=new Date,s=a.p.datatype!="local"&&a.p.loadonce||a.p.datatype=="xmlstring",A=a.p.xmlReader,z=a.p.datatype=="local"?"local":"xml";
    if(s){
        a.p.data=[];
        a.p._index={};
    ...
    if(b.isXMLDoc(e)){
        ...
        var u,w,r=0,G,O=0,S=0,K=0,L,Z=[],P,v={},B,H,U=[],ia=a.p.altRows===true?" "+a.p.altclass:"";
        A.repeatitems||(Z=T(z));
        ...
        if(b.isFunction(A.userdata))a.p.userData=A.userdata.call(a,e)||{};else b.jgrid.getXmlData(e,A.userdata,true).each(function(){
            a.p.userData[this.getAttribute("name")]=b(this).text()
            });
        e=b.jgrid.getXmlData(e,A.root,true);
        (e=b.jgrid.getXmlData(e,A.row,true))||
        (e=[]);
        var $=e.length,W=0,ha={},ja=parseInt(a.p.rowNum,10);
    ...
    if(e){
        ...
        if(a.p.datatype=="local"){
            ...
            var z=0,u,w,r=[],G,O=0,S=0,K=0,L,Z,P={},v,B,H=[],U=a.p.altRows===true?" "+a.p.altclass:"";
        ...
        var ia=parseInt(a.p.rowNum,10),$=a.p.scroll?b.jgrid.randId():1;
        if(p)ia*=p+1;
        ...
        if(a.p.grouping)b(a).jqGrid("groupingRender",ha,a.p.colModel.length);else a.p.treeGrid===true&&v>0?b(a.rows[v]).after(H.join("")):b("#"+b.jgrid.jqID(a.p.id)+" tbody:first").append(H.join(""))
            }
            if(a.p.subGrid===true)try{
        b(a).jqGrid("addSubGrid",O+K)
        }catch(ya){}
        a.p.totaltime=new Date-C;
    if(z>0)if(a.p.records===0)a.p.records=
        L;
    if(a.p.treeGrid===true)try{
...
if(b.isArray(a.p.data)){
    ...
    b.each(a.p.colModel,function(){
        ...
        if(A=="date"||A=="datetime"){
            if(this.formatter&&
                typeof this.formatter==="string"&&this.formatter=="date"){
...
var S=parseInt(a.p.rowNum,
    10),K=G.length,L=parseInt(a.p.page,10),Z=Math.ceil(K/S),P={};
...
x=function(e,f){
    var j="",m="<table cellspacing='0' cellpadding='0' border='0' style='table-layout:auto;' class='ui-pg-table'><tbody><tr>",p="",C,s,A,z,u=function(w){
        var r;
    ...
    b(".ui-pg-selbox","#"+C).bind("change",function(){
        ...
        a.p.rowNum=
        this.value;
        if(f)b(".ui-pg-selbox",a.p.pager).val(this.value);else a.p.toppager&&b(".ui-pg-selbox",a.p.toppager).val(this.value);
...
b("#first"+b.jgrid.jqID(f)+", #prev"+b.jgrid.jqID(f)+", #next"+b.jgrid.jqID(f)+", #last"+b.jgrid.jqID(f)).click(function(){
    var w=M(a.p.page,1),r=M(a.p.lastpage,1),G=false,O=true,S=true,K=true,L=true;
...
var Ea=function(e,f,j,m){
    if(a.p.colModel[f].sortable)if(!(a.p.savedRow.length>0)){
        if(!j){
            ...
            if(m)if(a.p.lastsort==f&&a.p.sortorder==m&&!j)return;else a.p.sortorder=m;
    ...
    for(f=j[0]=j[1]=j[2]=0;f<=e;f++)if(a.p.colModel[f].hidden===false)j[0]+=a.p.colModel[f].width+m;if(a.p.direction=="rtl")j[0]=a.p.width-j[0];
    ...
    var f,j=a.grid.headers,m=b.jgrid.getCellIndex(e);
...
if(a.p.autowidth===
    ...
    b.each(a.p.colModel,function(){
        ...
        if(this.hidden===false){
            e+=C+f;
            if(this.fixed)z+=C+f;else j++;
            u++
        }
    });
if(isNaN(a.p.width))a.p.width=h.width=e;else h.width=a.p.width;
    a.p.tblwidth=e;
...
if(y){
    ...
    }else a.p.multikey&&b(h.bDiv).bind("mousedown",function(){
    return false
    });
ea&&b(h.bDiv).hide();
...
if(a.p.toolbar[0]){
    ...
    if(a.p.toolbar[1]=="top")b(h.uDiv).insertBefore(h.hDiv);else a.p.toolbar[1]==
...
if(a.p.caption){
    ...
    if(a.p.hidegrid===true){
        b(".ui-jqgrid-titlebar-close",h.cDiv).click(function(e){
            var f=b.isFunction(a.p.onHeaderClick),j=".ui-jqgrid-bdiv, .ui-jqgrid-hdiv, .ui-jqgrid-pager, .ui-jqgrid-sdiv",m,p=this;
...
a.updatepager=function(e,f){
    var j,m,p,C,s,A,z,u="",w=a.p.pager?"_"+b.jgrid.jqID(a.p.pager.substr(1)):"",r=a.p.toppager?"_"+a.p.toppager.substr(1):"";
...
b("td.jqgrid-rownum",a.rows).each(function(G){
    b(this).html(p+1+G)
    });
...
setSelection:function(d,i){
    return this.each(function(){
        function g(x){
            var y=
            b(c.grid.bDiv)[0].clientHeight,E=b(c.grid.bDiv)[0].scrollTop,I=c.rows[x].offsetTop;
        ...
        if(typeof d=="undefined"){
            ...
            if(b(q).hasClass("jqgrow")){
                b("td",q).each(function(x){
                    ...
                    if(a!=="cb"&&a!=="subgrid"&&a!=="rn")if(l.p.treeGrid===true&&a==l.p.ExpandColumn)i[a]=b.jgrid.htmlDecode(b("span:first",this).html());else try{
                        i[a]=b.unformat(this,{
                            rowId:q.id,
...
setRowData:function(d,i,g){
    ...
    this.each(function(){
        ...
        if(l.p.datatype=="local"){
            var E=l.p._index[d];
            if(l.p.treeGrid)for(var I in l.p.treeReader)y.hasOwnProperty(l.p.treeReader[I])&&delete y[l.p.treeReader[I]];if(typeof E!="undefined")l.p.data[E]=b.extend(true,l.p.data[E],y);
            y=null
            }
        }catch(M){
        h=false
        ...
        if(h){
        if(x==="string")b(q).addClass(g);else x==="object"&&b(q).css(g);
...
addRowData:function(d,i,g,c){
    ...
    if(i){
        ...
        for(var T=0,J="",D={},
            ...
            if(this.rows.length===0)b("table:first",this.grid.bDiv).append(l);else switch(g){
                case "last":
        ...
        if(this.p.altRows===true&&!N)if(g=="last")(this.rows.length-1)%2==1&&b(this.rows[this.rows.length-1]).addClass(o);else b(this.rows).each(function(fa){
    ...
    this.each(function(){
        ...
        b(this.p.colModel).each(function(y){
            ...
            if(d=="set"){
                ...
                }else if(d=="get")l[h]=b("tr.footrow td:eq("+
            y+")",q.grid.sDiv).html()
            })
    });
return d=="get"?l:k
...
showHideCol:function(d,i){
    return this.each(function(){
        var g=this,c=false,h=b.browser.webkit||b.browser.safari?0:g.p.cellLayout,k;
        if(g.grid){
            if(typeof d==="string")d=[d];
            i=i!="none"?"":"none";
            var l=i===""?true:false,a=g.p.groupHeader&&(typeof g.p.groupHeader==="object"||b.isFunction(g.p.groupHeader));
            ...
            b(this.p.colModel).each(function(q){
                if(b.inArray(this.name,d)!==-1&&this.hidden===l){
                    ...
                    if(i==="none")g.p.tblwidth-=k+h;else g.p.tblwidth+=k+h;
                    this.hidden=!l;
                    c=true
                    }
                });
...
remapColumns:function(d,i,g){
    ...
    if(k.p.remapColumns)if(k.p.remapColumns.length)c(k.p.remapColumns);else k.p.remapColumns=b.makeArray(d);
...
setCell:function(d,i,g,c,h,k){
    return this.each(function(){
        ...
        if(l>=0)if(a=this.rows.namedItem(d)){
            ...
            if(typeof c==="string")b(x).addClass(c);else c&&b(x).css(c);
...
bindKeys:function(d){
    ...
    return this.each(function(){
        ...
        b(g).keydown(function(c){
            ...
            }else if(c.keyCode===13)b.isFunction(i.onEnter)&&i.onEnter.call(g,g.p.selrow);else c.keyCode===32&&b.isFunction(i.onSpace)&&i.onSpace.call(g,g.p.selrow)
            }
        })
})
},
...
b.fmatter.util={
    NumberFormat:function(a,c){
        ...
        if(b.fmatter.isNumber(a)){
            var d=a<0,f=a+"",g=c.decimalSeparator?c.decimalSeparator:".",e;
...
DateFormat:function(a,c,d,f){
    ...
    if(d in
    f.masks)d=f.masks[d];else d||(d="Y-m-d");
    a=i.getHours();
    c=i.getMinutes();
    h=i.getDate();
    e=i.getMonth()+1;
    j=i.getTimezoneOffset();
    var l=i.getSeconds(),n=i.getMilliseconds(),o=i.getDay(),p=i.getFullYear(),q=(o+6)%7+1,s=(new Date(p,e-1,h)-new Date(p,0,1))/864E5,t={
    d:g(h),
    D:k.i18n.dayNames[o],
    j:h,
...
b.fn.fmatter.select=function(a,c){
    ...
    }else if(b.fmatter.isObject(d))if(e)f=jQuery.map(h,function(n){
    return d[n]
    });else f[0]=d[a]||""
    }
    a=f.join(", ");
...
b.unformat=function(a,c,d,f){
    var g,e=c.colModel.formatter,h=c.colModel.formatoptions||

    {},i=/([\.\*\_\'\(\)\{\}\+\?\\])/g,j=c.colModel.unformat||b.fn.fmatter[e]&&b.fn.fmatter[e].unformat;
...
(function(a){
    a.jgrid.extend({
        ...
        setColProp:function(b,e){
            return this.each(function(){
                if(this.grid)if(e)for(var c=this.p.colModel,j=0;j<c.length;j++)if(c[j].name==b){
    ...
    sortGrid:function(b,e,c){
        return this.each(function(){
            ...
            if(this.grid){
                ...
                for(var k=0;k<this.p.colModel.length;k++)if(this.p.colModel[k].index==
                    b||this.p.colModel[k].name==b){
                    j=k;
                    break
                }
                if(j!=-1){
    ...
    return this.each(function(){
        ...
        if(!this.ftoolbar){
            ...
            if(b.stringResult===true||c.p.datatype=="local"){
                ...
                a.each(["searchField","searchString","searchOper"],function(r,v){
        ...
        a.each(c.p.colModel,function(){
            ...
            if(this.search)switch(this.stype){
                case "select":
                    ...
                    dataType:"html",
                    success:function(o){
                        if(f.buildSelect!==undefined)(o=f.buildSelect(o))&&a(g).append(o);else a(g).append(o);
                    ...
                    if(m){
                        ...
                        "object")for(n in m)if(m.hasOwnProperty(n)){
                        l=document.createElement("option");
                        l.value=n;
                        l.innerHTML=m[n];
                        i.appendChild(l)
...
if(b.stringResult===true||c.p.datatype=="local"){
    ...
    a.each(["searchField","searchString","searchOper"],function(q,r){
...
this.toggleToolbar=function(){
    var d=a("tr.ui-search-toolbar",c.grid.hDiv),g=c.p.frozenColumns===true?a("tr.ui-search-toolbar",c.grid.hDiv):false;
...
setGroupHeaders:function(b){
    ...
    return this.each(function(){
        ...
        var e=this,c,j,k=0,p,d,g,h,f,i=e.p.colModel,m=i.length,n=e.grid.headers,l=a("table.ui-jqgrid-htable",e.grid.hDiv),t=l.children("thead").children("tr.ui-jqgrid-labels:last").addClass("jqg-second-row-header");
        p=l.children("thead");
        var o,q=l.find(".jqg-first-row-header");
        if(q.html()===null)q=a("<tr>",{
            role:"row",
            "aria-hidden":"true"
        }).addClass("jqg-first-row-header").css("height","auto");else q.empty();
        var r,v=function(s,u){
            for(var w=0,x=u.length;w<x;w++)if(u[w].startColumnName===s)return w;return-1
            };
        ...
        if(this.grid){
            ...
            if(!(b.p.subGrid==true||b.p.treeGrid===true||b.p.cellEdit==true||b.p.sortable||b.p.scroll||b.p.grouping)){
                ...
                b.p.resizeStop=function(h,f){
                    ...
                    a("tr:first td:eq("+f+
                        ")",i).width(h);
                    if(a.isFunction(b.p.orgEvents.resizeStop))b.p.orgEvents.resizeStop.call(b,h,f);else b.p.orgEvents.resizeStop=null
                        };
                        
                b.p.orgEvents.onSortCol=a.isFunction(b.p.onSortCol)?b.p.onSortCol:null;
                b.p.onSortCol=function(h,f,i){
                    var m=a("tr.ui-jqgrid-labels:last th:eq("+b.p.lastsort+")",b.grid.fhDiv),n=a("tr.ui-jqgrid-labels:last th:eq("+f+")",b.grid.fhDiv);
...
(function(a){
    ...
    createModal:function(b,c,d,f,g,h,j){
        ...
        if(a.fn.jqm&&d.jqModal===true){
            ...
            i).click(function(){
            var o=a("#"+b.themodal).data("onClose")||d.onClose,s=a("#"+b.themodal).data("gbox")||d.gbox;
...
createEl:function(b,c,d,f,g){
    ...
    switch(b){
        ...
        case "select":
            ...
            success:function(m){
                var l=[],o=this.elem,s=this.vl,p=a.extend({},this.options),t=
                p.multiple===true;
        ...
        if(typeof c.value==="string"){
            ...
            for(k=0;k<q.length;k++){
                i=q[k].split(n);
                if(i.length>2)i[1]=a.map(i,function(m,l){
                    if(l>0)return m
                        }).join(":");
                ...
                g.innerHTML=i[1];
                e.appendChild(g);
                if(!b&&(a.trim(i[0])==a.trim(d)||a.trim(i[1])==a.trim(d)))g.selected=
                    "selected";
...
checkValues:function(b,c,d,f,g){
    ...
    if(h){
    j||(j=d.p.colNames[c]);
    if(h.required===true)if(this.isEmpty(b))return[false,
...
(function(a){
        ...
        searchGrid:function(f){
            ...
            if(e.grid){
                ...
                if(a("#"+G.themodal).html()!==null)b();
                    ...
                    var w=a("<div><div id='"+q+"' class='searchFilter' style='overflow:auto'></div></div>").insertBefore("#gview_"+e.p.id),n="left",j="";
            ...
            if(!B&&i||f.multipleSearch===false){
                ...
                if(H>=0&&s[H].searchoptions&&
                    s[H].searchoptions.sopt)J=s[H].searchoptions.sopt[0];
            ...
            n+"'>"+c+o+"</td><td class='EditButton' "+j+">"+t+M+"</td></tr></tbody></table>";
            a("#"+q).jqFilter({
                columns:s,
            ...
            w.append(n);
            m&&f.tmplFilters&&f.tmplFilters.length&&
            a(".ui-template",w).bind("change",function(){
                var u=a(this).val();
            ...
            C[f.sFilter]=l;
            a.each([f.sField,f.sValue,f.sOper],function(){
                C[this]=""
                })
            }else{
    ...
    a("#"+q+"_reset").bind("click",
        function(){
            var u={},C=a("#"+q);
            e.p.search=false;
            if(f.multipleSearch===false)u[f.sField]=u[f.sValue]=u[f.sOper]="";else u[f.sFilter]="";
            C[0].resetFilter();
...
editGridRow:function(f,b){
                ...
                if(g.length){
                    ...
                    a.each(c.p.colModel,function(){
                        if(this.name===k&&this.editoptions&&a.isFunction(this.editoptions.custom_value)){
                            try{
                                h[k]=
                                this.editoptions.custom_value(a("#"+a.jgrid.jqID(k),"#"+i),"get");
        ...
        a(k.p.colModel).each(function(S){
            ...
            if(E!=="cb"&&E!=="subgrid"&&this.editable===true&&E!=="rn"){
                if(I===false)r="";
                    ...
                    rowabove:false,
                    rowcontent:""
                },this.formoptions||{}),da=parseInt(Y.rowpos,10)||L+1,fa=parseInt((parseInt(Y.colpos,10)||1)*2,10);
                if(g=="_empty"&&X.defaultValue)r=a.isFunction(X.defaultValue)?
                    X.defaultValue():X.defaultValue;
                if(!this.edittype)this.edittype="text";
                if(c.p.autoencode)r=a.jgrid.htmlDecode(r);
                F=a.jgrid.createEl(this.edittype,X,r,false,a.extend({},a.jgrid.ajaxOptions,k.p.ajaxSelectOptions||{}));
    ...
    if(L>0){
        P=a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='"+
            (p*2-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='"+k.p.id+"_id' value='"+g+"'/></td></tr>");
        P[0].rp=L+999;
        a(v).append(P);
    ...
    if(g=="_empty"){
        a(F).each(function(){
            ...
            if((z=a("#"+a.jgrid.jqID(p),"#"+v))&&z.length&&z[0]!==null){
                ...
                z[0].defaultChecked=false;
                r=a(z).attr("offval")
                }else if(z[0].type&&z[0].type.substr(0,
                6)=="select")z[0].selectedIndex=0;else z.val(r);
    ...
    if(T){
        a('td[role="gridcell"]',T).each(function(I){
            ...
            if(p!=="cb"&&p!=="subgrid"&&p!=="rn"&&F[I].editable===true){
                if(p==k.p.ExpandColumn&&k.p.treeGrid===true)D=a(this).text();else try{
                    D=a.unformat(a(this),{
                        rowId:g,
                        colModel:F[I]
                        },I)
                ...
                switch(F[I].edittype){
                    ...
                    a("#"+p+" option","#"+v).each(function(){
                        this.selected=!F[I].editoptions.multiple&&(a.trim(D)==a.trim(a(this).text())||
                            P[0]==a.trim(a(this).text())||P[0]==a.trim(a(this).val()))?true:F[I].editoptions.multiple?a.inArray(a.trim(a(this).text()),P)>-1||a.inArray(a.trim(a(this).val()),P)>-1?true:false:false
                        });
                    break;
                    case "checkbox":
                        D+="";
                        ...
                        a("#"+p,"#"+
                            v)[c.p.useProp?"prop":"attr"]("defaultChecked",false)
                        }else{
                        D=D.toLowerCase();
                ...
                case "custom":
                    try{
                    if(F[I].editoptions&&a.isFunction(F[I].editoptions.custom_value))F[I].editoptions.custom_value(a("#"+
                        p,"#"+v),"set",D);else throw"e1";
                }catch(S){
...
function G(){
    ...
    r=a.extend({
        ...
        complete:function(F,T){
            ...
            if(T!="success"){
                k[0]=false;
                k[1]=a.isFunction(d[c.p.id].errorTextFormat)?d[c.p.id].errorTextFormat(F):T+" Status: '"+F.statusText+"'. Error code: "+
                F.status
            ...
            if(h[D]==p.addoper){
                ...
                if(d[c.p.id].closeAfterAdd){
                    ...
                    if(d[c.p.id].reloadAfterSubmit)a(c).trigger("reloadGrid");else c.p.treeGrid===true?a(c).jqGrid("addChildNode",k[2],L,h):a(c).jqGrid("addRowData",k[2],h,b.addedrow);
                    x("_empty",c,o)
...
if(!r.url&&!d[c.p.id].useDataProxy)if(a.isFunction(c.p.dataProxy))d[c.p.id].useDataProxy=
    true;
else{
    k[0]=false;
...
function j(){
    if(f!=="_empty"&&typeof c.p.savedRow!=="undefined"&&c.p.savedRow.length>0&&a.isFunction(a.fn.jqGrid.restoreRow))for(var g=
        0;g<c.p.savedRow.length;g++)if(c.p.savedRow[g].id==f){
    ...
    function M(){
    var g=a(c).jqGrid("getDataIDs"),k=a("#id_g","#"+i).val();
...
if(c.grid&&f){
    var t=c.p.id,o="FrmGrid_"+t,i="TblGrid_"+t,m={
        ...
        scrollelm:o
    },H=a.isFunction(d[c.p.id].beforeShowForm)?d[c.p.id].beforeShowForm:false,J=a.isFunction(d[c.p.id].afterShowForm)?d[c.p.id].afterShowForm:false,u=a.isFunction(d[c.p.id].beforeInitData)?d[c.p.id].beforeInitData:false,C=a.isFunction(d[c.p.id].onInitializeForm)?d[c.p.id].onInitializeForm:false,A=true,l=1,y=0,h,O,N,U;
    if(f==="new"){
        f="_empty";
        b.caption=d[c.p.id].addCaption
        }else b.caption=d[c.p.id].editCaption;
    b.recreateForm===true&&a("#"+m.themodal).html()!==
    null&&a("#"+m.themodal).remove();
    var Q=true;
    ...
    if(a("#"+m.themodal).html()!==null){
        ...
        b.bSubmit+"</a>",Z="<a href='javascript:void(0)' id='cData' class='fm-button ui-state-default ui-corner-all'>"+b.bCancel+"</a>";
        ...
        A+="<tr style='display:none' class='binfo'><td class='bottominfo' colspan='2'>"+d[c.p.id].bottominfo+
        "</td></tr>";
        A+="</tbody></table>";
        if(y>0){
            var aa=[];
...
if(d[c.p.id].checkOnSubmit||d[c.p.id].checkOnUpdate){
    ...
    a("<div class='ui-widget-overlay jqgrid-overlay confirm' style='z-index:"+
        K+";display:none;'>&#160;"+(a.browser.msie&&a.browser.version==6?'<iframe style="display:block;position:absolute;z-index:-1;filter:Alpha(Opacity=\'0\');" src="javascript:false;"></iframe>':"")+"</div><div class='confirm ui-widget-content ui-jqconfirm' style='z-index:"+(K+1)+"'>"+b.saveData+"<br/><br/>"+$+W+Z+"</div>").insertAfter("#"+o);
...
a("#pData","#"+i+"_2").click(function(){
    ...
    var g=M();
    if(g[0]!=-1&&g[1][g[0]-1]){
        if(a.isFunction(b.onclickPgButtons))b.onclickPgButtons("prev",a("#"+o),
            g[1][g[0]]);
        x(g[1][g[0]-1],c,o);
        a(c).jqGrid("setSelection",g[1][g[0]-1]);
...
viewGridRow:function(f,b){
    ...
    return this.each(function(){
        function e(){
            ...
            function q(l,y,h,O){
            for(var N,U,Q,K=0,V,W,$=[],Z=false,aa="<td class='CaptionTD form-view-label ui-widget-content' width='"+b.labelswidth+"'>&#160;</td><td class='DataTD form-view-data ui-helper-reset ui-widget-content'>&#160;</td>",ba="",g=["integer","number","currency"],k=0,v=0,p,E,D,
                z=1;z<=O;z++)ba+=z==1?aa:"<td class='CaptionTD form-view-label ui-widget-content'>&#160;</td><td class='DataTD form-view-data ui-widget-content'>&#160;</td>";
            a(y.p.colModel).each(function(){
                U=this.editrules&&this.editrules.edithidden===true?false:this.hidden===true?true:false;
                if(!U&&this.align==="right")if(this.formatter&&a.inArray(this.formatter,g)!==-1)k=Math.max(k,parseInt(this.width,10));else v=Math.max(v,parseInt(this.width,10))
                    });
            p=k!==0?k:v!==0?v:0;
            ...
            a(y.p.colModel).each(function(L){
                ...
                if(N!=="cb"&&N!=="subgrid"&&N!=="rn"&&D){
                    ...
                    {}),R=parseInt(r.rowpos,10)||K+1,F=parseInt((parseInt(r.colpos,10)||1)*2,10);
                    if(r.rowabove){
        ...
        if(Q=a(y).jqGrid("getInd",l,true)){
            a("td",Q).each(function(K){
                ...
                y.p.colModel[K].editrules.edithidden===true?false:y.p.colModel[K].hidden===true?true:false;
    ...
    function B(){
    var l=a(w).jqGrid("getDataIDs"),y=a("#id_g","#"+s).val();
...
if(w.grid&&f){
    var n=w.p.id,j="ViewGrid_"+n,s="ViewTbl_"+n,M={
        ...
        scrollelm:j
    },c=a.isFunction(b.beforeInitData)?b.beforeInitData:false,t=true,o=1,i=0;
    if(a("#"+M.themodal).html()!==null){
        if(c){
            t=c(a("#"+j));
            if(typeof t==
        ...
        var H=a("<table id='"+
            s+"' class='EditTable' cellspacing='1' cellpadding='2' border='0' style='table-layout:fixed'><tbody></tbody></table>");
        if(c){
            t=c(a("#"+j));
        ...
        var J="<a href='javascript:void(0)' id='"+(c?"pData":"nData")+"' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e'></span></a>",u="<a href='javascript:void(0)' id='cData' class='fm-button ui-state-default ui-corner-all'>"+b.bClose+"</a>";
        if(i>0){
            var C=[];
...
b.closeicon=a.extend([true,"left","ui-icon-close"],b.closeicon);
if(b.closeicon[0]===true)a("#cData","#"+s+"_2").addClass(b.closeicon[1]=="right"?"fm-button-icon-right":
...
delGridRow:function(f,b){
    ...
    return this.each(function(){
        var e=this;
        if(e.grid)if(f){
            var q=a.isFunction(d[e.p.id].beforeShowForm),x=a.isFunction(d[e.p.id].afterShowForm),G=a.isFunction(d[e.p.id].beforeInitData)?d[e.p.id].beforeInitData:
            false,B=e.p.id,w={},n=true,j="DelTbl_"+B,s,M,c,t,o={
                themodal:"delmod"+B,
                modalhead:"delhd"+B,
            ...
            if(a("#"+o.themodal).html()!==null){
                ...
                d[e.p.id].msg+"</td></tr><tr><td >&#160;</td></tr>";
                i+="</tbody></table></div>";
                ...
                if(b.delicon[0]===true)a("#dData",
                    "#"+j+"_2").addClass(b.delicon[1]=="right"?"fm-button-icon-right":"fm-button-icon-left").append("<span class='ui-icon "+b.delicon[2]+"'></span>");
                ...
                a("#dData","#"+j+"_2").click(function(){
                    ...
                    if(a.isFunction(d[e.p.id].onclickSubmit))w=d[e.p.id].onclickSubmit(d[e.p.id],
                        H)||{};
                    ...
                    if(m[0]&&!d[e.p.id].processing){
                        ...
                        M=c.id;
                        H=H.split(",");
                        for(var J in H)if(H.hasOwnProperty(J))H[J]=a.jgrid.stripPref(e.p.idPrefix,H[J]);s[M]=H.join();
                        J=a.extend({
                            url:d[e.p.id].url?d[e.p.id].url:a(e).jqGrid("getGridParam","editurl"),
                            type:d[e.p.id].mtype,
                            data:a.isFunction(d[e.p.id].serializeDelData)?
                            d[e.p.id].serializeDelData(s):s,
                    ...
                    if(!J.url&&!d[e.p.id].useDataProxy)if(a.isFunction(e.p.dataProxy))d[e.p.id].useDataProxy=
                        true;
                    else{
                        m[0]=false;
...
navGrid:function(f,b,e,q,x,G,B){
    ...
    return this.each(function(){
        if(!this.nav){
            ...
            if(!(!n.grid||
                ...
                if(b.view){
                    ...
                    a(j).append("<div class='ui-pg-div'><span class='ui-icon "+b.viewicon+"'></span>"+b.viewtext+
                        "</div>");
                    a("tr",c).append(j);
                    a(j,c).attr({
                        title:b.viewtitle||"",
        ...
        if(b.search){
            ...
            a(j).append("<div class='ui-pg-div'><span class='ui-icon "+b.searchicon+
                "'></span>"+b.searchtext+"</div>");
            a("tr",c).append(j);
            a(j,c).attr({
                title:b.searchtitle||"",
                id:G.id||"search_"+o
            ...
            if(b.refresh){
            j=a("<td class='ui-pg-button ui-corner-all'></td>");
            a(j).append("<div class='ui-pg-div'><span class='ui-icon "+
                b.refreshicon+"'></span>"+b.refreshtext+"</div>");
            a("tr",c).append(j);
            a(j,c).attr({
    ...
    return this.each(function(){
        if(this.grid){
            ...
            if(e)if(!(b.id&&a("#"+b.id,e).html()!==null)){
                var x=a("<td></td>");
                b.buttonicon.toString().toUpperCase()=="NONE"?a(x).addClass("ui-pg-button ui-corner-all").append("<div class='ui-pg-div'>"+
                    b.caption+"</div>"):a(x).addClass("ui-pg-button ui-corner-all").append("<div class='ui-pg-div'><span class='ui-icon "+b.buttonicon+"'></span>"+b.caption+"</div>");
                b.id&&a(x).attr("id",b.id);
                if(b.position=="first")e.rows[0].cells.length===0?a("tr",e).append(x):a("tr td:eq(0)",e).before(x);else a("tr",e).append(x);
    ...
    return this.each(function(){
        ...
        if(e.grid){
            ...
            if(q)for(var x in q)a("[name="+a.jgrid.jqID(x)+"]",b).is("input:radio")||a("[name="+a.jgrid.jqID(x)+"]",b).is("input:checkbox")?a("[name="+a.jgrid.jqID(x)+"]",b).each(function(){
                if(a(this).val()==q[x])a(this)[e.p.useProp?"prop":"attr"]("checked",true);else a(this)[e.p.useProp?"prop":"attr"]("checked",false)
...
FormToGrid:function(f,b,e,q){
    return this.each(function(){
        if(this.grid){
            ...
            if(e=="add")a(this).jqGrid("addRowData",f,G,q);else e=="set"&&a(this).jqGrid("setRowData",f,G)
                }
            })
}
})
...
(function(c){
    c.fn.jqFilter=function(k){
        ...
        return this.each(function(){
            if(!this.filter){
                this.p=o;
                if(this.p.filter===null||this.p.filter===
                    undefined)this.p.filter={
                    groupOp:this.p.groupOps[0].op,
                    rules:[],
                    groups:[]
                };
                
                var q,x=this.p.columns.length,j,y=/msie/i.test(navigator.userAgent)&&!window.opera;
                ...
                if(x){
                    for(q=0;q<x;q++){
                        ...
                        else if(!j.searchtype)j.searchtype=
                            "string";
                ...
                var z=function(d,g){
                    var a=[true,""];
                    if(c.isFunction(g.searchrules))a=
                        g.searchrules(d,g);
            ...
            this.reDraw=function(){
                ...
                c(this).append(d);
                c.isFunction(this.p.afterRedraw)&&this.p.afterRedraw.call(this,
                    this.p)
                };
                ...
                if(this.p.ruleButtons===true){
                    ...
                    f.bind("click",function(){
                        ...
                        for(b=0;b<a.p.columns.length;b++){
                            var n=typeof a.p.columns[b].search==="undefined"?true:a.p.columns[b].search,s=a.p.columns[b].hidden===true;
                        ...
                        op:(m.searchoptions.sopt?
                            m.searchoptions.sopt:a.p.sopt?a.p.sopt:m.searchtype==="string"?a.p.stropts:a.p.numopts)[0],
                        data:""
                    });
                    a.reDraw();
                        return false
            ...
            return this.each(function(){
                ...
                if(i.grid){
                        ...
                        a('td[role="gridcell"]',r).each(function(k){
                            ...
                            if(z)q=a("span:first",
                                ...
                                if(j[k].editable===true){
                                    ...
                                    var p=a.extend({},j[k].editoptions||{},{
                                        id:c+"_"+e,
                                        name:e
                                    });
                                    if(!j[k].edittype)j[k].edittype="text";
                                    if(q=="&nbsp;"||q=="&#160;"||q.length==1&&q.charCodeAt(0)==160)q="";
                                    p=a.jgrid.createEl(j[k].edittype,
                                        p,q,true,a.extend({},a.jgrid.ajaxOptions,i.p.ajaxSelectOptions||{}));
                    ...
                    if(w>0){
                        ...
                        m.keys===true&&a(r).bind("keydown",function(k){
                            if(k.keyCode===27){
                                a(i).jqGrid("restoreRow",
                                    c,f);
                                return false
                                }
                                if(k.keyCode===13){
...
saveRow:function(c,d,b,h,l,n,s){
    ...
    if(a.jgrid.realType(o[0])==="Object")f=o[0];
        ...
        if(a.isFunction(s))f.afterrestorefunc=
            s
            }
            f=a.extend(true,{
        successfunc:null,
            ...
            if(i!="cb"&&i!="subgrid"&&j.editable===true&&i!="rn"&&!a(this).hasClass("not-editable-cell")){
                switch(j.edittype){
                    ...
                    case "custom":
                        ...
                        y=="e2"?a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_value' "+a.jgrid.edit.msg.novalue,a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,
                            y.message,a.jgrid.edit.bClose)
                        }
                    }
...
if(e){
            ...
            if(t==="success"){
                ...
                if(a.isFunction(f.successfunc)){
                    ...
                    if(a.isArray(y)){
                        ...
                        if(u===true){
                    g.p.autoencode&&a.each(e,function(B,C){
                        e[B]=a.jgrid.htmlDecode(C)
                        });
                    e=a.extend({},e,q);
                    a(g).jqGrid("setRowData",
                        c,e);
                    a(r).attr("editable","0");
    ...
    error:function(p,t){
        a("#lui_"+g.p.id).hide();
        if(a.isFunction(f.errorfunc))f.errorfunc.call(g,c,p,t);else try{
            a.jgrid.info_dialog(a.jgrid.errors.errcap,
                '<div class="ui-state-error">'+p.responseText+"</div>",a.jgrid.edit.bClose,{
                    buttonalign:"right"
                })
            }catch(u){
                    ...
                    if(!(h=="subgrid"||h=="cb"||h=="rn")){
                        ...
                        if(i.editable===true&&a===true&&!g.hasClass("not-editable-cell")){
                            ...
                            b("input, select, textarea",g).bind("keydown",function(l){
                                if(l.keyCode===27)if(b("input.hasDatepicker",g).length>0)b(".ui-datepicker").is(":hidden")?b(c).jqGrid("restoreCell",d,f):b("input.hasDatepicker",g).datepicker("hide");else b(c).jqGrid("restoreCell",d,f);
                                l.keyCode===13&&b(c).jqGrid("saveCell",d,f);
                                if(l.keyCode==9)if(c.grid.hDiv.loading)return false;else l.shiftKey?b(c).jqGrid("prevCell",d,f):b(c).jqGrid("nextCell",
                                    d,f);
                                l.stopPropagation()
                                });
...
saveCell:function(d,f){
    return this.each(function(){
        ...
        if(!(!a.grid||a.p.cellEdit!==true)){
            ...
            if(c!==null){
                var h=b("td:eq("+f+")",a.rows[d]),e,g,i=a.p.colModel[f],k=i.name,j=b.jgrid.jqID(k);
                switch(i.edittype){
                    case "select":
                        if(i.editoptions.multiple){
                        j=b("#"+d+"_"+j,a.rows[d]);
                        var m=[];
                        if(e=b(j).val())e.join(",");else e="";
                        ...
                        e=b("#"+d+
                            "_"+j+">option:selected",a.rows[d]).val();
                    ...
                    case "custom":
                        ...
                        if(i.editoptions&&b.isFunction(i.editoptions.custom_value)){
                            ...
                            if(e===undefined)throw"e2";else g=e
                                }else throw"e1";
                    }catch(q){
                ...
                if(r[0]===true){
                    ...
                    if(a.p.cellsubmit=="remote")if(a.p.cellurl){
                            ...
                            complete:function(o,p){
                                ...
                                if(p=="success")if(b.isFunction(a.p.afterSubmitCell)){
                                    ...
                                    if(s[0]===true){
                                        ...
                                        a.p.afterSaveCell.call(a,a.rows[d].id,k,e,d,f);
                        ...
                        error:function(o,p){
                            ...
                            a.p.errorCell.call(a,o,p):b.jgrid.info_dialog(b.jgrid.errors.errcap,o.status+" : "+o.statusText+"<br/>"+p,b.jgrid.edit.bClose);
                            b(a).jqGrid("restoreCell",d,f)
                            }
...
nextCell:function(d,f){
    return this.each(function(){
        ...
        if(!(!this.grid||this.p.cellEdit!==true)){
            ...
            if(a!==false)b(this).jqGrid("editCell",d,a,true);else this.p.savedRow.length>0&&b(this).jqGrid("saveCell",d,f)
                }
            })
},
...
GridNav:function(){
    return this.each(function(){
        function d(g,i,k){
            if(k.substr(0,1)=="v"){
                var j=b(a.grid.bDiv)[0].clientHeight,m=b(a.grid.bDiv)[0].scrollTop,l=a.rows[g].offsetTop+a.rows[g].clientHeight,q=a.rows[g].offsetTop;
                if(k=="vd")if(l>=j)b(a.grid.bDiv)[0].scrollTop=b(a.grid.bDiv)[0].scrollTop+a.rows[g].clientHeight;
                if(k=="vu")if(q<m)b(a.grid.bDiv)[0].scrollTop=b(a.grid.bDiv)[0].scrollTop-
...
if(!(!a.grid||a.p.cellEdit!==true)){
    a.p.knv=a.p.id+"_kn";
    var c=b("<span style='width:0px;height:0px;background-color:black;' tabindex='0'><span tabindex='-1' style='width:0px;height:0px;background-color:grey' id='"+a.p.knv+"'></span></span>"),h,e;
    ...
    b("#"+a.p.knv).focus().keydown(function(g){
        ...
        switch(e){
            ...
            case 13:
                parseInt(a.p.iCol,
                10)>=0&&parseInt(a.p.iRow,10)>=0&&b(a).jqGrid("editCell",a.p.iRow,a.p.iCol,true);
                break;
            default:
                return true
                }
        ...
        return this.each(function(){
            ...
            if(a.grid){
                var n=function(g,j,e){
                    ...
                    var e,
                    c,h,k,i,o=b("<table cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"),m=b("<tr></tr>");
                    for(c=0;c<a.p.subGridModel[0].name.length;c++){
                        e=b("<th class='ui-state-default ui-th-subgrid ui-th-column ui-th-"+a.p.direction+"'></th>");
                        b(e).html(a.p.subGridModel[0].name[c]);
                        b(e).width(a.p.subGridModel[0].width[c]);
                ...
                function(){
                    ...
                    if(b(this).hasClass("sgcollapsed")){
                        ...
                        if(b.isFunction(a.p.subGridRowColapsed)){
                            ...
                            if(p===false)return false;
                        if(a.p.subGridOptions.reloadOnExpand===true)b(q).remove(".ui-subgrid");else b(q).hasClass("ui-subgrid")&&b(q).hide();
    ...
    return this.each(function(){
        if(this.grid||f)if(this.p.subGrid===true){
            ...
            if(d){
                ...
                if(a)b(a).trigger("click");else(a=b("td.sgexpanded",d)[0])&&b(a).trigger("click")
                    }
                }
        })
}
...
(function(e){
    ...
    groupingToggle:function(a){
        this.each(function(){
            var c=this.p.groupingView,b=a.lastIndexOf("_"),d=a.substring(0,b+1);
    ...
    groupingRender:function(a,c){
        return this.each(function(){
            var b=this,d=b.p.groupingView,g="",h="",f,k=d.groupCollapse?d.plusicon:d.minusicon,l,r,m;
...
(function(d){
    d.jgrid.extend({
        setTreeNode:function(a,c){
            return this.each(function(){
                var b=this;
                if(b.grid&&b.p.treeGrid)for(var e=b.p.expColInd,g=b.p.treeReader.expanded_field,h=b.p.treeReader.leaf_field,f=b.p.treeReader.level_field,l=b.p.treeReader.icon_field,i=b.p.treeReader.loaded,j,o,n,k;a<c;){
...
getFullTreeNode:function(a){
    ...
    this.each(function(){
        ...
        if(this.grid&&this.p.treeGrid)switch(this.p.treeGridModel){
            case "nested":
                var e=
                this.p.treeReader.left_field,g=this.p.treeReader.right_field,h=this.p.treeReader.level_field,f=parseInt(a[e],10),l=parseInt(a[g],10),i=parseInt(a[h],10);
                d(this.p.data).each(function(){
...
delTreeNode:function(a){
    return this.each(function(){
        var c=
        this.p.localReader.id,b=this.p.treeReader.left_field,e=this.p.treeReader.right_field,g,h,f;
        if(this.grid&&this.p.treeGrid){
            ...
            if(l!==undefined){
                ...
                if(this.p.treeGridModel==="nested"){
                    ...
                    if(c.length)for(f in c)c[f][b]=parseInt(c[f][b],
...
addChildNode:function(a,c,b){
    ...
    if(e.p.treeGridModel==="nested"){
        ...
        if(c!==null){
            ...
            if(f.length)for(q in f)f[q][j]=parseInt(f[q][j],10)+2;b[i]=h+1;
            b[j]=h+2
            }
        }
    ...
    json2xml:function(a,b){
        var h=function(d,c,i){
            ...
            for(j in d)if(d.hasOwnProperty(j))if(j.charAt(0)===
                "@")g+=" "+j.substr(1)+'="'+d[j].toString()+'"';else k=true;g+=k?">":"/>";
            if(k){
                for(j in d)if(d.hasOwnProperty(j))if(j==="#text")g+=d[j];
                    else if(j==="#cdata")g+="<![CDATA["+d[j]+"]]\>";
                    else if(j.charAt(0)!=="@")g+=h(d[j],j,i+"\t");g+=(g.charAt(g.length-1)==="\n"?i:"")+"</"+c+">"
                }
...
e="",f;
for(f in a)if(a.hasOwnProperty(f))e+=h(a[f],f,"");return b?e.replace(/\t/g,b):e.replace(/\t|\n/g,"")
},
toObj:function(a){
    var b={},h=/function/i;
    if(a.nodeType===1){
        if(a.attributes.length){
            ...
            if(d)if(e<2&&f<2){
                ...
                for(c=a.firstChild;c;c=c.nextSibling)if(c.nodeType===3)b["#text"]=this.escape(c.nodeValue);
                    else if(c.nodeType===4)if(h.test(c.nodeValue))b[c.nodeName]=[b[c.nodeName],c.nodeValue];else b["#cdata"]=this.escape(c.nodeValue);
                ...
                if(b==="__EMPTY_ARRAY_")b="[]";
                    ...
                    }else if(f)if(f>1)b=this.escape(this.innerXml(a));else for(c=a.firstChild;c;c=c.nextSibling)if(h.test(a.firstChild.nodeValue)){
...
toJson:function(a,b,h,e){
    ...
    if(a==="[]")f+=b?":[]":"[]";
        ...
        i=[];
        for(g in a)if(a.hasOwnProperty(g))i[i.length]=this.toJson(a[g],g,h+d,e);f+=(b?
            ":{":"{")+(i.length>1?c+h+d+i.join(","+c+h+d)+c+h:i.join(""))+"}"
...
function tableToGrid(n,o){
    jQuery(n).each(function(){
        if(!this.grid){
            ...
            var a=jQuery(this).width(),d=jQuery("tr td:first-child input[type=checkbox]:first",jQuery(this)),b=jQuery("tr td:first-child input[type=radio]:first",jQuery(this));
            d=d.length>0;
            b=!d&&b.length>0;
            var l=d||b,c=[],g=[];
...
columnChooser:function(b){
    function h(d,k){
        if(d)if(typeof d=="string")a.fn[d]&&a.fn[d].apply(k,a.makeArray(arguments).slice(2));else a.isFunction(d)&&d.apply(k,a.makeArray(arguments).slice(2))
            }
            var c=this;
...
if(a.ui)if(a.ui.multiselect)if(b.msel=="multiselect"){
    ...
    var g=
c.jqGrid("getGridParam","colModel"),j=c.jqGrid("getGridParam","colNames"),i={},l=[];
    e.empty();
    a.each(g,function(d){
    i[this.name]=d;
    if(this.hidedlg)this.hidden||l.push(d);else e.append("<option value='"+d+"' "+(this.hidden?"":"selected='selected'")+">"+j[d]+"</option>")
        });
                    ...
                    return a.extend({
                        ...
                        drop:function(g,j){
                            if(a(j.draggable).hasClass("jqgrow")){
                                ...
                                if(!e.dropbyname){
                                    var l=
                                    0,m={},d,k=a("#"+this.id).jqGrid("getGridParam","colModel");
                                    try{
                                        for(var p in i){
