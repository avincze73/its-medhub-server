 ...
 */
public class ItsAuthenticationFilter implements Filter {
    ...
    public ItsAuthenticationFilter() {
    }

    private void doBeforeProcessing(RequestWrapper request, ResponseWrapper response)
            throws IOException, ServletException {
        if (debug) {
            log("ItsAuthenticationFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(RequestWrapper request, ResponseWrapper response)
            throws IOException, ServletException {
        if (debug) {
            log("ItsAuthenticationFilter:DoAfterProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (debug) {
            log("ItsAuthenticationFilter:doFilter()");
        }
        ...
        try {
            ...
            if (wrappedRequest.getSession().getAttribute("itsUser") == null) {
                wrappedResponse.sendRedirect(filterConfig.getInitParameter("loginPage"));
            } else {
        ...
        System.out.println(wrappedRequest.getSession());
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("ItsAuthenticationFilter: Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("ItsAuthenticationFilter()");
        }
        StringBuffer sb = new StringBuffer("ItsAuthenticationFilter(");
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter(String name, String[] values) {
            if (debug) {
                System.out.println("ItsAuthenticationFilter::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("ItsAuthenticationFilter::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("ItsAuthenticationFilter::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("ItsAuthenticationFilter::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("ItsAuthenticationFilter::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
