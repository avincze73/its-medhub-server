 ...
 * */
public class BEBufferedRandomAccessFileTDS extends BufferedRandomAccessFileTDS
...
//    }
     ...
     * @exception java.io.IOException If an I/O error ocurred.
     * */
    public BEBufferedRandomAccessFileTDS(byte[] outData, int expectedSize, String mode) throws IOException, J2KTDSException
	{
		super(outData, expectedSize, mode);
		byteOrdering = BIG_ENDIAN;
    }
