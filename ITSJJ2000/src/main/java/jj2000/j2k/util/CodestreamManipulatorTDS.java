 ...
 * */
public class CodestreamManipulatorTDS
{
	...
	/** The output data, amit a konstruktorban kap */
    private OutDataTDS outData;

	/** A kimeneti tomb varhato merete */
     ...
     * */
    public CodestreamManipulatorTDS(byte[] outData, int expectedSize, int nt, int pptp, boolean ppm,
                                 boolean ppt, boolean tempSop,
                                 boolean tempEph)
	{
		this.outData = new OutDataTDS();
     ...
     * */
    public int doCodestreamManipulation() throws IOException, J2KTDSException{
        BEBufferedRandomAccessFileTDS fi;
        ...
        fi = new  BEBufferedRandomAccessFileTDS(outData.data, expectedSize, "rw+");
     ...
     * @exception java.io.IOException If an I/O error ocurred.
     * */
    private void parseAndFind(BufferedRandomAccessFileTDS fi) throws IOException{
     ...
     * @exception java.io.IOException If an I/O error ocurred.
     * */
    private void readAndBuffer(BufferedRandomAccessFileTDS fi)throws IOException{
     ...
     * @exception java.io.IOException If an I/O error ocurred.
     * */
    private void writeNewCodestream(BufferedRandomAccessFileTDS fi)
